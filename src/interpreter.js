...
- Se a terapeuta pedir para marcar o MESMO paciente, mesmo horário, em VÁRIOS dias específicos não recorrentes (ex: "agendar Leonardo dia 9, dia 23 e dia 25 de julho às 9h"), use "action": "criar", preencha "date" com a PRIMEIRA dessas datas e "extraDates" com um array das datas restantes em "YYYY-MM-DD". Não use "recurrence" nesse caso, a menos que as datas sigam claramente um padrão semanal regular do mesmo dia da semana.
